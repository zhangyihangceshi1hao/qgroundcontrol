...
Button {
    ...
    property bool   showBorder:     true //qgcPal.globalTheme === QGCPalette.Light
    ...
    background: Rectangle {
        ...
        radius:         backRadius
        border.width:   showBorder ? (_showHighlight ? 2 : 1) : 0
        border.color:   _showHighlight ? "#1E90FF" : qgcPal.buttonText
        color:          "transparent"
        /*
